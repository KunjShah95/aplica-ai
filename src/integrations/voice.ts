...
export class VoiceService {
  ...
  async speechToText(audioBuffer: Buffer, options: STTOptions = {}): Promise<TranscriptionResult> {
  ...
  async speechToTextFile(filePath: string, options: STTOptions = {}): Promise<TranscriptionResult> {
