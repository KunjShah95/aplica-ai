...
export const manifest = {
    ...
    parameters: [
        ...
        },
        {
            ...
            type: 'string',
            required: true,
            description: 'The role/persona of the sub-agent (e.g., "Senior Python Developer", "Legal Expert")',
        },
        {
            name: 'context',
            type: 'string',
...
export class DelegateSkill {
    ...
    async execute(context) {
        ...
        try {
            ...
            const orchestrator = createAgentOrchestrator(llmProvider, 5); // Limit sub-agent iterations
      ...
      `;
            ...
            const subAgentResponse = await orchestrator.run(`[SYSTEM: ACT AS ${role}]\nTask: ${task}\nContext: ${taskContext}`, {
                userId: userId,
                maxIterations: 5,
