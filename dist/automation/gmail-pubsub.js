    ...
    async handlePushNotification(message) {
        try {
            ...
            if (notification.emailMessage) {
                const emailMeta = notification.emailMessage;
                const metadata = emailMeta.metadata;
...
export const createGmailPubSub = (config) => new GmailPubSub(config);
//# sourceMappingURL=gmail-pubsub.js.map