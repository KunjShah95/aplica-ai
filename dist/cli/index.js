...
import { handleChat, handleStatus, handleConfig, handleHelp, handleViral, handleShare, handleSecurity, handleOnboarding, } from './commands.js';
...
async function main() {
    ...
    try {
        ...
        console.error('\n❌ Error starting Alpicia:', error instanceof Error ? error.message : String(error));
        console.log('\n  Make sure you have:');
