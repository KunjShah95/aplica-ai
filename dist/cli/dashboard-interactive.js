...
╚═══════════════════════════════════════════════════════════════╝`;
    ...
    async spawnAgent(args) {
        ...
        const session = sessionManager.createSession(agentId, `${type.charAt(0).toUpperCase() + type.slice(1)} Agent`, type, {
...
//# sourceMappingURL=dashboard-interactive.js.map