...
export class GatewayServer {
    ...
    async startDiscord() {
        ...
        try {
            ...
            console.error('Failed to start Discord bot:', error instanceof Error ? error.message : String(error));
    ...
    async startSlack() {
        ...
        try {
            ...
            console.error('Failed to start Slack bot:', error instanceof Error ? error.message : String(error));
