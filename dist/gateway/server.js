...
export class GatewayServer {
    ...
    async startTelegram() {
        ...
        try {
            ...
            console.log(`   ✗ Telegram   - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startDiscord() {
        ...
        try {
            ...
            console.log(`   ✗ Discord    - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startSlack() {
        ...
        try {
            ...
            console.log(`   ✗ Slack      - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startWhatsApp() {
        ...
        try {
            ...
            console.log(`   ✗ WhatsApp   - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startSignal() {
        ...
        try {
            ...
            console.log(`   ✗ Signal     - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startGoogleChat() {
        ...
        try {
            ...
            console.log(`   ✗ Google Chat - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startMSTeams() {
        ...
        try {
            ...
            console.log(`   ✗ MS Teams   - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startMatrix() {
        ...
        try {
            ...
            console.log(`   ✗ Matrix     - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async startWebChat() {
        ...
        try {
            ...
            console.log(`   ✗ Web Chat   - ${error instanceof Error ? error.message : 'failed to start'}`);
        }
    }
    async stop() {
        if (!this.isRunning) {
        ...
        const stopPromises = [];
        if (this.wsGateway)
            stopPromises.push(this.wsGateway.stop());
        if (this.telegramAdapter)
            stopPromises.push(this.telegramAdapter.stop());
        if (this.discordAdapter)
            stopPromises.push(this.discordAdapter.stop());
        if (this.slackAdapter)
            stopPromises.push(this.slackAdapter.stop());
        if (this.whatsappAdapter)
            this.whatsappAdapter.disconnect();
        if (this.signalAdapter)
            stopPromises.push(this.signalAdapter.stop());
        if (this.googleChatAdapter)
            stopPromises.push(this.googleChatAdapter.stop());
        if (this.msTeamsAdapter)
            stopPromises.push(this.msTeamsAdapter.stop());
        if (this.matrixAdapter)
            stopPromises.push(this.matrixAdapter.stop());
        if (this.webChatAdapter)
            stopPromises.push(this.webChatAdapter.stop());
